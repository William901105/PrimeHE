...
# This file was *autogenerated* from the file tool.sage
from sage.all_cmdline import *   # import sage library

_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_123 = Integer(123); _sage_const_456 = Integer(456); _sage_const_2 = Integer(2)
import os
load('primehe.sage')
def system_random8():
...
A = rand_poly1 * _sage_const_123  + _sage_const_456  
B = rand_poly2
...
reconstructed_A = Rq(_sage_const_0 )
for i in range(l):
    # 將分解出的第 i 個多項式，乘上 2^i 加回去
    reconstructed_A += vec_A[i] * (_sage_const_2 **i)
